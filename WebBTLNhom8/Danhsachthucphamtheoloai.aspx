        ...
        <asp:DataList ID="DataList1" runat="server" DataKeyField="MaTP" DataSourceID="SqlDsThucPham" RepeatColumns="3" Width="695px">
            <ItemTemplate>
                <table style="width: 100%; text-align: center">
                    <tr>
                        <td>
                            <a href="Chitietthucpham.aspx?MaTP=<%# Eval("MaTP") %>">
                                <asp:Image ID="Image1" runat="server" Height="200px" ImageUrl='<%# Eval("urlAnh", "~/images/{0}") %>' Width="200px" /></a>
                            <br />
                            ...
                            <span><span style="font-size: larger; color: #CC0000"><strong>Giá:</strong></span></span><span class="pro_detail_offer">
                                <strong>
                                    <asp:Label ID="DongiaLabel" runat="server" Style="font-size: larger; color: #CC0000" Text='<%# string.Format("{0:#,0 VND}", Convert.ToInt32( Eval("Dongia"))) %>' />
                                </strong>
                            </span>
                        </td>
                    </tr>
